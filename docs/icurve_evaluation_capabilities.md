...
| Interval certification (I3) | Plane/sphere/cylinder/cone/ring-torus | §18.3; Empty/Unique/Undetermined; spindle Unavailable |
| Runtime `PK_CURVE_eval` for icurve | Analytic supports | Decode → bind → prepare → eval |
| Real Parasolid oracle (analytic) | Plane∩sphere/cone D0+D1; skew cylinders | `scripts/IcurveEvaluationOracle.cs` |
